...
namespace PolytecOrderEDI
{
    ...
    static class CustomDrillingOnGenericPiece
    {
        ...
        private static void SetDrillingProperties()
        {
            ...
            //09-04-2026 Wangchuk 'Replaced above code block
            LINS            = vinylPart?.RINS               ?? DrawerFrontParams?.RINS  ?? 0;     // The LINS of the Back view is the RINS of the Front view
            RINS            = vinylPart?.LINS               ?? DrawerFrontParams?.LINS  ?? 0;     // The RINS of the Back view is the LINS of the Front view 
