...
static class ValidateVinylParts
{
    ...
    private static string StyleProfileValidation(VinylPart CurrentProduct)
    {
        ...
        //if (Part.ProductType == PRODUCTTYPE.Decorative16mm || Part.ProductType == PRODUCTTYPE.Decorative18mm)
        //{
        //    if (Part.StyleProfile != "") errorMessage += $"This product don't require Style Profile.\n";
        //}
    ...
    private static string DoorInfoValidation(VinylPart CurrentProduct)
    {
        ...
        {
            //if (Part.height > 1800 && Part.midRailHeight == 0 && (DoorStyles.GetDoorStyle(Part.faceProfile) > 1))
            //{
            //    PantryDoorNoMidRailMsg += $"Line no {Part.lineNo}: Missing midrail height\n";
            //}

            // Wangchuk, 21-11-2024
            // Commented out the above if-block and added a new if-block below
            // We will force user to add mid rail height to a pantry. If they don't want a mid rail, they have to change pantry door to a door.
        ...
        if (CurrentProduct.Product == PRODUCT.Door)
        {
            ...
            //if (Part.midRailHeight > 0) errorMessage += $"Remove midrail height info.\n";
    ...
    private static string EdgeMouldValidation(VinylPart CurrentProduct)
    {
        ...
        //    if (Part.EdgeMould != "")
        //    {
        //        errorMessage += $"Leave the Edge mould field blank for Decorative products.\n";
        //    }
        //}   
